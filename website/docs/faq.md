...
Start every conversation with the header snippet from the repository, then issue your first line as `!<tag> [--modifier ...]`. Mirror the workflow described in the guide and spec.
